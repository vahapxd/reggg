...
client.on("ready", () => {
    console.log(chalk.redBright(`Rencia Register Bot Aktif!`))
})
...
member.roles.add(ayarlar.kayıtsızRol)//Youtube BoranGkdn
    ...
    kanal.send(`
Eternal'e Hoş Geldin, <@`+ member + `>! Sayende Sunucumuz **`+üyesayısı+`** kişi. 
...
Ceza işlemlerin <#976161222384816158> kanalını okuduğun varsayılarak uygulanır. ( <@&976512278012776458> )`)});
